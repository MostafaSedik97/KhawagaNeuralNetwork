...
setup (
  ...
  url = 'https://github.com/YousefKhawaga/NeuralNetwork',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/YousefKhawaga/NeuralNetwork/archive/0.1.tar.gz',    # I explain this later on
